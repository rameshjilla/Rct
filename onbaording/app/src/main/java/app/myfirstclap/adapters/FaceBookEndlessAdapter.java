...
public class FaceBookEndlessAdapter extends ArrayAdapter<FacebookFeed.News> {

    private Context context;
    private List<FacebookFeed.News> newsfeedlist;
    ...
    public FaceBookEndlessAdapter(Context context, List<FacebookFeed.News> newsfeedlist, int LayoutId) {
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        holder.description.setText(newsfeedlist.get(i).getMessage());
       /* holder.caption.setText(newsfeedlist.get(i).getFrom().getId());*/

        Glide.with(context).load(newsfeedlist.get(i).getFullPicture()).thumbnail(1f)
