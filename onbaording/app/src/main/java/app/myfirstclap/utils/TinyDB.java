...
import app.myfirstclap.model.UserSettings;
...
//    }
  ...
  public List<UserSettings> getListObject(String key, Class<?> mClass) {
    Gson gson = new Gson();
    List<String> objStrings = getListString(key);
    List<UserSettings> objects = new ArrayList<UserSettings>();

    for (String jObjString : objStrings) {
      UserSettings value = (UserSettings) gson.fromJson(jObjString, mClass);
      objects.add(value);
    }
    return objects;
  }

  public void putListObject(String key, List<UserSettings> objArray) {
    checkForNullKey(key);
    Gson gson = new Gson();
    ArrayList<String> objStrings = new ArrayList<String>();
    for (Object obj : objArray) {
  ...
  public User getUserObject(String key, Class<User> classOfT) {

    String json = getString(key);
    User value = new Gson().fromJson(json, classOfT);
