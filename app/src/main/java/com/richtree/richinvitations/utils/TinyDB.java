...
//    }
  ...
  public User getObject(String key, Class<User> classOfT) {
...
//    }
  ...
  public ProductDetailsData getProductDetailsObject(String key, Class<ProductDetailsData> classOfT) {

    String json = getString(key);
    ProductDetailsData value = new Gson().fromJson(json, classOfT);
